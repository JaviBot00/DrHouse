...
COPY DrHouse-Servlets/pom.xml .
RUN mvn dependency:go-offline -B

# Ahora copia el código fuente y compila
COPY DrHouse-Servlets/src ./src
...
COPY --from=build /app/target/DrHouse-Servlets.war \
    /usr/local/tomcat/webapps/DrHouse-Servlets.war
